...
// Busca todos os clientes, menus, submenus, tipos de erro, níveis de dificuldade
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $success_message = "Atendimento registrado com sucesso! Redirecionando...";
    } else {
...
<style>
        /* Estilos específicos para incluir atendimento */
