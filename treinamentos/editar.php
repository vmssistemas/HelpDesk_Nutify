...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($stmt->execute()) {
        ...
        $error = "Erro ao atualizar treinamento: " . $conn->error;
    }
}
?>
...
<div class="card">
    <div class="card-header bg-primary text-white">
        <h5 class="mb-0"><i class="material-icons me-2">edit</i> Editar Treinamento #<?= $treinamento['id'] ?></h5>
    </div>
    <div class="card-body">
        <?php if (isset($error)): ?>
            ...
            <div class="row g-3">
                ...
                <div class="col-md-8">
                    ...
                    <input type="text" class="form-control" id="titulo" name="titulo" 
                           value="<?= htmlspecialchars($treinamento['titulo']) ?>" required maxlength="100">
                </div>
                ...
                <div class="col-12">
                    ...
                    <textarea class="form-control d-none" id="descricao" name="descricao"><?= htmlspecialchars($treinamento['descricao']) ?></textarea>
                    <div id="editor"></div>
                </div>
                    ...
                    <select id="cliente_id" name="cliente_id" class="form-select">
                        ...
                        <?php foreach ($clientes_list as $cliente): ?>
                            <option value="<?= $cliente['id'] ?>" 
                                    ...
                                    <?= $cliente['id'] == $treinamento['cliente_id'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-4">
                    ...
                    <select id="plano_id" name="plano_id" class="form-select" disabled>
                        ...
                        <?php foreach ($planos_list as $plano): ?>
                            <option value="<?= $plano['id'] ?>" <?= $plano['id'] == $treinamento['plano_id'] ? 'selected' : '' ?>>
                                <?= htmlspecialchars($plano['nome']) ?>
                            </option>
                        <?php endforeach; ?>
                    </select>
                    <input type="hidden" id="plano_id_hidden" name="plano_id" value="<?= $treinamento['plano_id'] ?>">
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select id="responsavel_id" name="responsavel_id" class="form-select">
                        ...
                        <?php foreach ($equipe_list as $membro): ?>
                            <option value="<?= $membro['id'] ?>" <?= $membro['id'] == $treinamento['responsavel_id'] ? 'selected' : '' ?>>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control datepicker" id="data_treinamento" name="data_treinamento" 
                           value="<?= $treinamento['data_treinamento'] ? date('d/m/Y H:i', strtotime($treinamento['data_treinamento'])) : '' ?>" 
                ...
                <div class="col-12 mt-4">
                    ...
                    <a href="visualizar.php?id=<?= $treinamento['id'] ?>" class="btn btn-outline-secondary">
...
ClassicEditor
    ...
    .then(editor => {
        ...
        if (descricaoTextarea.value) {
            editor.setData(descricaoTextarea.value);
        }
