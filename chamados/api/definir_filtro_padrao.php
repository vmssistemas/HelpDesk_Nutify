...
// Define como padrão
if (definirFiltroPadrao($filtro_id, $usuario_id)) {
    echo json_encode(['success' => true, 'message' => 'Filtro definido como padrão com sucesso']);
} else {
    echo json_encode(['success' => false, 'message' => 'Erro ao definir filtro padrão']);
}